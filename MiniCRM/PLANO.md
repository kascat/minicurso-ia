...
> **Variante desta pasta:** projeto **do zero** — porta de host **3010**, container `minicrm-do-zero`. As demais variantes usam o mesmo conteúdo e diferem apenas na porta e no nome do container: semi-iniciado (3011 / `minicrm-semi`) e backup (3012 / `minicrm-backup`).
...
services:
  minicrm:
    build: .
    container_name: minicrm-do-zero
...
# acesse http://localhost:3010 (container minicrm-do-zero)
```
